    ...
    <html>
      <head>
        ...
        <style>
          ...
          body { font-family: 'Courier New', Courier, monospace; width: 72mm; padding: 4mm; margin: 0 auto; color: #000; line-height: 1.3; }
          .center { text-align: center; }
          .hr { border-top: 1px dashed #000; margin: 8px 0; }
          .bold { font-weight: bold; }
          .flex-between { display: flex; justify-content: space-between; }
          .calligraphy { font-family: 'Great Vibes', cursive; font-size: 20px; color: #222; margin: 5px 0; }
      ...
      <body>
        ...
        <div style="font-size: 13px;">
          ...
          ${totalSavings > 0 ? `<div class="flex-between" style="font-weight: bold;"><span>Discount</span><span>- KES ${totalSavings.toLocaleString()}</span></div>` : ''}
          ...
          ${isCash ? `
            <div class="flex-between" style="font-weight: bold; font-size: 14px; margin-top: 4px;">
              <span>CHANGE</span><span>KES ${changeAmount.toLocaleString()}</span>
            </div>` : `
        ...
        <div class="center" style="margin-top: 20px;">
          ...
          <div style="font-size: 13px; font-weight: 900; margin-top: 4px; border-top: 1px solid #000; display: inline-block; padding-top: 4px;">KARIBU TENA</div>
        </div>
        <script>
