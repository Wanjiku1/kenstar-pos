...
export function BulkAddTool({ onSuccess }: { onSuccess: () => void }) {
  ...
  return (
    <div className="bg-white p-6 rounded-3xl border-2 border-dashed border-slate-200 h-full flex flex-col justify-between">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <input 
            ...
            className="p-3 bg-slate-50 rounded-xl border font-bold text-sm"
            value={productName} 
          ...
          <input 
            ...
            className="p-3 bg-slate-50 rounded-xl border font-bold text-blue-600 text-sm"
            value={basePrice} 
      ...
      <button 
        ...
        disabled={loading}
        className="w-full mt-6 bg-amber-500 hover:bg-amber-600 text-white p-4 rounded-xl font-black transition-all shadow-lg active:scale-95 disabled:opacity-50 text-xs tracking-wide"
      >
